...
par_spreads([1 7],:) = par_spreads([1 7],:).*1.1843;
par_spreads(2,:) = par_spreads(2,:).*1.1843;
par_spreads([3 4],:) = par_spreads([3 4],:).*1.1843;
par_spreads([5 9],:) = par_spreads([5 9],:).*1.1843;
par_spreads(6,:) = par_spreads(6,:).*1.1843;
par_spreads(8,:) = par_spreads(8,:).*1.1843;
...
for k = 1:num_of_cds
    ...
    cds_prices(k) = (PVexpectedPayoff - PVexpectedPayments - PVaccrualPayments)*usdcad*(1.04905);
