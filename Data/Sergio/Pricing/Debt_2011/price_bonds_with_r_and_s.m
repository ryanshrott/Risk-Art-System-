...
%     fprintf('Currency: %s\n', currency{k})
    ...
    switch sectors{k}
        case 'Communications'
            the_spreads = the_spreads.*1.1346;
        case 'Financial'
            the_spreads = the_spreads.*1.179;
        case 'Government'
            the_spreads = the_spreads.*1.0159;
        case 'Technology'
            the_spreads = the_spreads.*1.1126;
        case 'Utilities'
            the_spreads = the_spreads.*1.1176;      
    end
    ...
    bond_prices([1:5 7:10]) = bond_prices([1:5 7:10]).*usdcad*(1.04905);
    bond_prices(6) = bond_prices(6)*eurcad*(1-0.01263)*(1.04905);
