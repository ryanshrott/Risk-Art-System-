...
par_spreads([1 7],:) = par_spreads([1 7],:).*1.3642;
par_spreads(2,:) = par_spreads(2,:).*2.0069;
par_spreads([3 4],:) = par_spreads([3 4],:).*1.405;
par_spreads([5 9],:) = par_spreads([5 9],:).*1.482;
par_spreads(6,:) = par_spreads(6,:).*1.3951;
par_spreads(8,:) = par_spreads(8,:).*1.6297;
...
for k = 1:num_of_cds
    ...
    cds_prices(k) = (PVexpectedPayoff - PVexpectedPayments - PVaccrualPayments)*usdcad*(1.0465);
