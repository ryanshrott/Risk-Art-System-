...
%     fprintf('Currency: %s\n', currency{k})
    ...
    switch sectors{k}
        case 'Communications'
            the_spreads = the_spreads.*1.3385;
        case 'Financial'
            the_spreads = the_spreads.*1.4134;
        case 'Government'
            the_spreads = the_spreads.*1.4953;
        case 'Technology'
            the_spreads = the_spreads.*1.3464;
        case 'Utilities'
            the_spreads = the_spreads.*1.2998;      
    end
    ...
    bond_prices([1:5 7:10]) = bond_prices([1:5 7:10]).*usdcad*(1.0465);
    bond_prices(6) = bond_prices(6)*eurcad*(1-0.1178)*(1.0465);
