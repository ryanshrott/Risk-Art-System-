...
par_spreads([1 7],:) = par_spreads([1 7],:).*1.7004;
par_spreads(2,:) = par_spreads(2,:).*1.8076;
par_spreads([3 4],:) = par_spreads([3 4],:).*1.6276;
par_spreads([5 9],:) = par_spreads([5 9],:).*1.9086;
par_spreads(8,:) = par_spreads(8,:).*1.8976; 
...
for k = 1:num_of_cds
    ...
    cds_prices(k) = (PVexpectedPayoff - PVexpectedPayments - PVaccrualPayments)*usdcad*(1.02338);
